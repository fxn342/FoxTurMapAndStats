...
def fxDrawStats(fxWarConquest, fxWorkingData, foxholeFont, fxConfig):
    ...
    #Open Icons
    fxStatsIntelCenterColonial = Image.open(fxConfig['Stats']['fxStatsIntelCenterColonial']).convert('RGBA')
    fxStatsIntelCenterWarden = Image.open(fxConfig['Stats']['fxStatsIntelCenterWarden']).convert('RGBA')
    ...
    fxStatsWeatherStationColonial = Image.open(fxConfig['Stats']['fxStatsWeatherStationColonial']).convert('RGBA')
    fxStatsWeatherStationWarden = Image.open(fxConfig['Stats']['fxStatsWeatherStationWarden']).convert('RGBA')  
    ...
    fxStatsBackground.paste(fxStatsIntelCenterColonial, eval(fxConfig['Stats']['fxStatsIntelCenterColonialXY']), fxStatsIntelCenterColonial)
    fxStatsBackground.paste(fxStatsIntelCenterWarden, eval(fxConfig['Stats']['fxStatsIntelCenterWardenXY']), fxStatsIntelCenterWarden)
    fxStatsBackground.paste(fxStatsWeatherStationColonial, eval(fxConfig['Stats']['fxStatsWeatherStationColonialXY']), fxStatsWeatherStationColonial)
    fxStatsBackground.paste(fxStatsWeatherStationWarden, eval(fxConfig['Stats']['fxStatsWeatherStationWardenXY']), fxStatsWeatherStationWarden)    
    ...
    fxDrawText.text(eval(fxConfig['Stats']['fxStatsTotalWeatherStationColonialXY']), str(fxWorkingData.fxTotalColonialWeatherStations), anchor="ms", fill ="white", font = fxFoxholeFont, align ="center")
    fxDrawText.text(eval(fxConfig['Stats']['fxStatsTotalWeatherStationWardenXY']), str(fxWorkingData.fxTotalWardenWeatherStations), anchor="ms", fill ="white", font = fxFoxholeFont, align ="center")
